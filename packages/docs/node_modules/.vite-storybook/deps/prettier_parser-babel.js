...
var require_parser_babel = __commonJS({
  "../../node_modules/prettier/parser-babel.js"(exports, module) {
    (function(e) {
      ...
      var Ct = b((Wf, ni) => {
        var ph = Et(), bt = Function.prototype.call;
        ni.exports = ph ? bt.bind(bt) : function() {
          return bt.apply(bt, arguments);
        };
      });
      var ui = b((hi) => {
        "use strict";
        var oi = {}.propertyIsEnumerable, li = Object.getOwnPropertyDescriptor, fh = li && !oi.call({ 1: 2 }, 1);
        hi.f = fh ? function(u) {
          var f = li(this, u);
      ...
      var ne = b((Xf, di) => {
        var pi = Et(), fi = Function.prototype, dh = fi.bind, gs = fi.call, mh = pi && dh.bind(gs, gs);
        di.exports = pi ? function(l) {
          return l && mh(l);
        } : function(l) {
          return l && function() {
      ...
      var As = b((Zf, Pi) => {
        var Eh = W(), bh = Eh.TypeError;
        Pi.exports = function(l) {
          if (l == null)
            throw bh("Can't call method on " + l);
          return l;
        };
      });
      var wt = b((ed, Ai) => {
      ...
      var Cs = b((hd, Ri) => {
        var Oh = W(), Mh = tt(), Bh = oe(), _h = Ci(), Rh = bs(), jh = Oh.Object;
      ...
      var $i = b((pd, Hi) => {
        ...
        Hi.exports = function(l, u) {
          var f = l[u];
          return f == null ? void 0 : Kh(f);
        };
      });
      var Vi = b((fd, zi) => {
        var Wh = W(), Ss = Ct(), ws = oe(), Is = Fe(), Gh = Wh.TypeError;
        zi.exports = function(l, u) {
          var f, d;
          if (u === "string" && ws(f = l.toString) && !Is(d = Ss(f, l)) || ws(f = l.valueOf) && !Is(d = Ss(f, l)) || u !== "string" && ws(f = l.toString) && !Is(d = Ss(f, l)))
            return d;
      ...
      var be = b((Pd, ta) => {
        ...
        ta.exports = Object.hasOwn || function(u, f) {
          return au(iu(u), f);
        };
      });
      var Ds = b((Ad, sa) => {
      ...
      var st = b((Td, oa) => {
        var uu = W(), cu = Ns(), ra = be(), pu = Ds(), ia = Es(), na = bs(), ze = cu("wks"), Le = uu.Symbol, aa = Le && Le.for, fu = na ? Le : Le && Le.withoutSetter || pu;
        oa.exports = function(l) {
          if (!ra(ze, l) || !(ia || typeof ze[l] == "string")) {
            var u = "Symbol." + l;
            ia && ra(Le, l) ? ze[l] = Le[l] : na && aa ? ze[l] = aa(u) : ze[l] = fu(u);
          }
          return ze[l];
        };
      });
      var ca = b((vd, ua) => {
        var du = W(), mu = Ct(), la = Fe(), ha = Cs(), yu = $i(), xu = Vi(), gu = st(), Pu = du.TypeError, Au = gu("toPrimitive");
        ua.exports = function(l, u) {
          if (!la(l) || ha(l))
            return l;
          var f = yu(l, Au), d;
          if (f) {
            if (u === void 0 && (u = "default"), d = mu(f, l, u), !la(d) || ha(d))
              return d;
      ...
      var ma = b((bd, da) => {
        var Eu = W(), fa = Fe(), Ls = Eu.document, bu = fa(Ls) && fa(Ls.createElement);
        da.exports = function(l) {
          return bu ? Ls.createElement(l) : {};
        };
      });
      var Os = b((Cd, ya) => {
        var Cu = De(), Su = ge(), wu = ma();
        ya.exports = !Cu && !Su(function() {
      ...
      var Ms = b((ga) => {
        var Iu = De(), Nu = Ct(), ku = ui(), Du = xs(), Fu = wt(), Lu = Fs(), Ou = be(), Mu = Os(), xa = Object.getOwnPropertyDescriptor;
        ga.f = Iu ? xa : function(u, f) {
          if (u = Fu(u), f = Lu(f), Mu)
            try {
              return xa(u, f);
            } catch {
      ...
      var Us = b((ba) => {
        ...
        ba.f = Hu ? zu ? function(u, f, d) {
          if (Ft(u), f = Ea(f), Ft(d), typeof u == "function" && f === "prototype" && "value" in d && qs in d && !d[qs]) {
            var y = Ku(u, f);
            y && y[qs] && (u[f] = d.value, d = { configurable: js in d ? d[js] : y[js], enumerable: Rs in d ? d[Rs] : y[Rs], writable: false });
          }
          return _s(u, f, d);
        } : _s : function(u, f, d) {
          if (Ft(u), f = Ea(f), Ft(d), $u)
            try {
              return _s(u, f, d);
            } catch {
            }
      ...
      var Lt = b((kd, Ca) => {
        ...
        Ca.exports = Wu ? function(l, u, f) {
          return Gu.f(l, u, Ju(1, f));
        } : function(l, u, f) {
          return l[u] = f, l;
        };
      });
      ...
      var ja = b((Md, Ra) => {
        var ic = Na(), _a = W(), zs = ne(), ac = Fe(), nc = Lt(), Vs = be(), Ks = Dt(), oc = Fa(), lc = $s(), Oa = "Object already initialized", Gs = _a.TypeError, hc = _a.WeakMap, Mt, rt, Bt, uc = function(l) {
          return Bt(l) ? rt(l) : Mt(l, {});
        }, cc = function(l) {
          return function(u) {
            var f;
            if (!ac(u) || (f = rt(u)).type !== l)
              throw Gs("Incompatible receiver, " + l + " required");
            return f;
          };
        };
        ic || Ks.state ? (Ce = Ks.state || (Ks.state = new hc()), Ma = zs(Ce.get), Ws = zs(Ce.has), Ba = zs(Ce.set), Mt = function(l, u) {
          if (Ws(Ce, l))
            throw new Gs(Oa);
          return u.facade = l, Ba(Ce, l, u), u;
        }, rt = function(l) {
          return Ma(Ce, l) || {};
        }, Bt = function(l) {
          return Ws(Ce, l);
      ...
      var Ha = b((Bd, Ua) => {
        var Js = De(), pc = be(), qa = Function.prototype, fc = Js && Object.getOwnPropertyDescriptor, Xs = pc(qa, "name"), dc = Xs && function() {
        }.name === "something", mc = Xs && (!Js || Js && fc(qa, "name").configurable);
        Ua.exports = { EXISTS: Xs, PROPER: dc, CONFIGURABLE: mc };
      });
      var Wa = b((_d, Ka) => {
        var yc = W(), $a = oe(), xc = be(), za = Lt(), gc = kt(), Pc = Ot(), Va = ja(), Ac = Ha().CONFIGURABLE, Tc = Va.get, vc = Va.enforce, Ec = String(String).split("String");
        (Ka.exports = function(l, u, f, d) {
          var y = d ? !!d.unsafe : false, A = d ? !!d.enumerable : false, g = d ? !!d.noTargetGet : false, T = d && d.name !== void 0 ? d.name : u, S;
          if ($a(f) && (String(T).slice(0, 7) === "Symbol(" && (T = "[" + String(T).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"), (!xc(f, "name") || Ac && f.name !== T) && za(f, "name", T), S = vc(f), S.source || (S.source = Ec.join(typeof T == "string" ? T : ""))), l === yc) {
            A ? l[u] = f : gc(u, f);
            return;
          } else
      ...
      var nn = b(($d, an) => {
        var Mc = ne(), Qs = be(), Bc = wt(), _c = sn().indexOf, Rc = $s(), rn = Mc([].push);
        an.exports = function(l, u) {
          var f = Bc(l), d = 0, y = [], A;
          for (A in f)
            !Qs(Rc, A) && Qs(f, A) && rn(y, A);
          for (; u.length > d; )
            Qs(f, A = u[d++]) && (~_c(y, A) || rn(y, A));
          return y;
        };
      });
      var ln = b((zd, on) => {
      ...
      var dn = b((Wd, fn) => {
        ...
        fn.exports = Hc("Reflect", "ownKeys") || function(u) {
          var f = zc.f(Kc(u)), d = Vc.f;
          return d ? Wc(f, d(u)) : f;
        };
      });
      var xn = b((Gd, yn) => {
        var mn = be(), Gc = dn(), Jc = Ms(), Xc = Us();
        yn.exports = function(l, u, f) {
          for (var d = Gc(u), y = Xc.f, A = Jc.f, g = 0; g < d.length; g++) {
            var T = d[g];
            !mn(l, T) && !(f && mn(f, T)) && y(l, T, A(u, T));
          }
        };
      });
      var Pn = b((Jd, gn) => {
        var Yc = ge(), Qc = oe(), Zc = /#|\.prototype\./, it = function(l, u) {
          var f = tp[ep(l)];
          return f == rp ? true : f == sp ? false : Qc(u) ? Yc(u) : !!u;
      ...
      var er = b((Xd, An) => {
        ...
        An.exports = function(l, u) {
          var f = l.target, d = l.global, y = l.stat, A, g, T, S, F, I;
          if (d ? g = Zs : y ? g = Zs[f] || op(f, {}) : g = (Zs[f] || {}).prototype, g)
            for (T in u) {
              if (F = u[T], l.noTargetGet ? (I = ip(g, T), S = I && I.value) : S = g[T], A = hp(d ? T : f + (y ? "." : "#") + T, l.forced), !A && S !== void 0) {
      ...
      var Sn = b((sm, Cn) => {
        var bn = ne(), fp = Nt(), dp = Et(), mp = bn(bn.bind);
        Cn.exports = function(l, u) {
          return fp(l), u === void 0 ? l : dp ? mp(l, u) : function() {
      ...
      var Nn = b((rm, In) => {
        "use strict";
        var yp = W(), xp = tr(), gp = _t(), Pp = Sn(), Ap = yp.TypeError, wn = function(l, u, f, d, y, A, g, T) {
          for (var S = y, F = 0, I = g ? Pp(g, T) : false, E, L; F < d; ) {
            if (F in f) {
              if (E = I ? I(f[F], F, u) : f[F], A > 0 && xp(E))
      ...
      var On = b((am, Ln) => {
        var Ep = W(), bp = Fn(), Cp = oe(), Rt = St(), Sp = st(), wp = Sp("toStringTag"), Ip = Ep.Object, Np = Rt(function() {
          return arguments;
        ...
        Ln.exports = bp ? Rt : function(l) {
          var u, f, d;
          return l === void 0 ? "Undefined" : l === null ? "Null" : typeof (f = kp(u = Ip(l), wp)) == "string" ? f : Np ? Rt(u) : (d = Rt(u)) == "Object" && Cp(u.callee) ? "Arguments" : d;
        };
      });
      var qn = b((nm, jn) => {
      ...
      var Wn = b(() => {
        ...
        Vp({ target: "Array", proto: true }, { flatMap: function(u) {
          var f = Gp(this), d = Jp(f), y;
          return Wp(u), y = Xp(f, 0), y.length = Kp(y, f, f, d, 0, 1, u, arguments.length > 1 ? arguments[1] : void 0), y;
        } });
      });
      var Uf = b((xm, Eo) => {
        vn();
        ...
        var nr = Object.defineProperty, Yp = Object.getOwnPropertyDescriptor, or = Object.getOwnPropertyNames, Qp = Object.prototype.hasOwnProperty, Zn = (l, u) => function() {
          ...
          for (var f in u)
            nr(l, f, { get: u[f], enumerable: true });
        }, ef = (l, u, f, d) => {
          if (u && typeof u == "object" || typeof u == "function")
            for (let y of or(u))
              !Qp.call(l, y) && y !== f && nr(l, y, { get: () => u[y], enumerable: !(d = Yp(u, y)) || d.enumerable });
          return l;
        }, tf = (l) => ef(nr({}, "__esModule", { value: true }), l), V = Zn({ "<define:process>"() {
        } }), sf = K({ "src/utils/try-combinations.js"(l, u) {
          "use strict";
          V();
          function f() {
            let d;
...
`);
          ...
          u.exports = f;
        } }), rf = K({ "src/utils/text/skip-inline-comment.js"(l, u) {
          "use strict";
          V();
          function f(d, y) {
            if (y === false)
          ...
          u.exports = f;
        } }), af = K({ "src/utils/text/skip-newline.js"(l, u) {
          "use strict";
          V();
          function f(d, y, A) {
            let g = A && A.backwards;
...
` || T === "\r" || T === "\u2028" || T === "\u2029")
          ...
          var d = f(/\s/), y = f(" 	"), A = f(",; 	"), g = f(/[^\n\r]/);
          u.exports = { skipWhitespace: d, skipSpaces: y, skipToLineEnd: A, skipEverythingButNewLine: g };
        } }), nf = K({ "src/utils/text/skip-trailing-comment.js"(l, u) {
          "use strict";
          V();
          var { skipEverythingButNewLine: f } = to();
          function d(y, A) {
            return A === false ? false : y.charAt(A) === "/" && y.charAt(A + 1) === "/" ? f(y, A) : A;
          }
          u.exports = d;
        } }), of = K({ "src/utils/text/get-next-non-space-non-comment-character-index-with-start-index.js"(l, u) {
          "use strict";
          V();
          var f = rf(), d = af(), y = nf(), { skipSpaces: A } = to();
          function g(T, S) {
            let F = null, I = S;
            for (; I !== F; )
              F = I, I = A(T, I), I = f(T, I), I = y(T, I), I = d(T, I);
            return I;
          }
          u.exports = g;
        } }), so = {};
        Zp(so, { EOL: () => ar, arch: () => lf, cpus: () => ho, default: () => mo, endianness: () => ro, freemem: () => oo, getNetworkInterfaces: () => fo, hostname: () => io, loadavg: () => ao, networkInterfaces: () => po, platform: () => hf, release: () => co, tmpDir: () => rr, tmpdir: () => ir, totalmem: () => lo, type: () => uo, uptime: () => no });
        function ro() {
          if (typeof jt > "u") {
            var l = new ArrayBuffer(2), u = new Uint8Array(l), f = new Uint16Array(l);
            if (u[0] = 1, u[1] = 2, f[0] === 258)
              jt = "BE";
            else if (f[0] === 513)
              jt = "LE";
            else
        ...
        var jt, ir, ar, mo, uf = Zn({ "node-modules-polyfills:os"() {
          V(), ir = rr, ar = `
`, mo = { EOL: ar, tmpdir: ir, tmpDir: rr, networkInterfaces: po, getNetworkInterfaces: fo, release: co, type: uo, cpus: ho, totalmem: lo, freemem: oo, uptime: no, loadavg: ao, hostname: io, endianness: ro };
        } }), cf = K({ "node-modules-polyfills-commonjs:os"(l, u) {
          V();
          var f = (uf(), tf(so));
          if (f && f.default) {
            u.exports = f.default;
            ...
            f && (u.exports = f);
        } }), pf = K({ "node_modules/detect-newline/index.js"(l, u) {
          "use strict";
          V();
          var f = (d) => {
            if (typeof d != "string")
...
`;
          ...
          u.exports = f, u.exports.graceful = (d) => typeof d == "string" && f(d) || `
`;
        } }), ff = K({ "node_modules/jest-docblock/build/index.js"(l) {
          "use strict";
          V(), Object.defineProperty(l, "__esModule", { value: true }), l.extract = j, l.parse = $, l.parseWithComments = G, l.print = M, l.strip = k;
          function u() {
            let h = cf();
            return u = function() {
              return h;
          ...
          function M(h) {
            let { comments: J = "", pragmas: ae = {} } = h, Y = (0, f().default)(J) || u().EOL, Me = "/**", ee = " *", H = " */", B = Object.keys(ae), v = B.map((te) => _(te, ae[te])).reduce((te, he) => te.concat(he), []).map((te) => `${ee} ${te}${Y}`).join("");
            if (!J) {
              if (B.length === 0)
                return "";
              if (B.length === 1 && !Array.isArray(ae[B[0]])) {
                let te = ae[B[0]];
                return `${Me} ${_(B[0], te)[0]}${H}`;
              }
            }
            let We = J.split(Y).map((te) => `${ee} ${te}`).join(Y) + Y;
            return Me + Y + (J ? We : "") + (J && B.length ? ee + Y : "") + v + H;
          }
          function _(h, J) {
            return L.concat(J).map((ae) => `@${h} ${ae}`.trim());
          }
        } }), df = K({ "src/common/end-of-line.js"(l, u) {
          "use strict";
          V();
          function f(g) {
            let T = g.indexOf("\r");
...
`);
          ...
          u.exports = { guessEndOfLine: f, convertEndOfLineToChars: d, countEndOfLineChars: y, normalizeEndOfLine: A };
        } }), mf = K({ "src/language-js/pragma.js"(l, u) {
          "use strict";
          V();
          var { parseWithComments: f, strip: d, extract: y, print: A } = ff(), { normalizeEndOfLine: g } = df(), T = eo();
          function S(E) {
            let L = T(E);
            L && (E = E.slice(L.length + 1));
            let j = y(E), { pragmas: k, comments: $ } = f(j);
            return { shebang: L, text: E, pragmas: k, comments: $ };
          }
          function F(E) {
          ...
          function I(E) {
            let { shebang: L, text: j, pragmas: k, comments: $ } = S(E), G = d(j), M = A({ pragmas: Object.assign({ format: "" }, k), comments: $.trimStart() });
            return (L ? `${L}
` : "") + g(M) + (G.startsWith(`
`) ? `
` : `
...
`) + G;
          ...
          u.exports = { locStart: d, locEnd: y, hasSameLocStart: A, hasSameLoc: T };
        } }), xo = K({ "src/language-js/parse/utils/create-parser.js"(l, u) {
          "use strict";
          V();
          var { hasPragma: f } = mf(), { locStart: d, locEnd: y } = yo();
          function A(g) {
          ...
          V();
          function f(d, y) {
            let A = new SyntaxError(d + " (" + y.start.line + ":" + y.start.column + ")");
            return A.loc = y, A;
          }
          u.exports = f;
          ...
          function d(y) {
            ...
            return f(A.replace(/ \(.*\)/, ""), { start: { line: g ? g.line : 0, column: g ? g.column + 1 : 0 } });
          }
          u.exports = d;
        } }), yf = K({ "src/language-js/utils/is-ts-keyword-type.js"(l, u) {
          "use strict";
          V();
          function f(d) {
            let { type: y } = d;
          ...
          u.exports = f;
        } }), xf = K({ "src/language-js/utils/is-block-comment.js"(l, u) {
          "use strict";
          V();
          var f = /* @__PURE__ */ new Set(["Block", "CommentBlock", "MultiLine"]), d = (y) => f.has(y == null ? void 0 : y.type);
          u.exports = d;
        } }), gf = K({ "src/language-js/utils/is-type-cast-comment.js"(l, u) {
          "use strict";
          V();
          var f = xf();
          function d(y) {
            return f(y) && y.value[0] === "*" && /@type\b/.test(y.value);
          }
          u.exports = d;
        } }), Pf = K({ "src/utils/get-last.js"(l, u) {
          "use strict";
          V();
          ...
          function d(y, A) {
            ...
            throw f(A, { start: { line: g.line, column: g.column + 1 }, end: { line: T.line, column: T.column + 1 } });
          }
          u.exports = d;
        } }), Af = K({ "src/language-js/parse/postprocess/typescript.js"(l, u) {
          "use strict";
          V();
          var f = lr(), d = Po(), y = Ao(), A = { AbstractKeyword: 126, SourceFile: 308, PropertyDeclaration: 169 };
          function g(I) {
          ...
          function T(I) {
            ...
            if (!f(E))
              return;
            let [{ expression: L }] = E, j = g(L), [k, $] = [L.pos, L.end].map((G) => {
              let { line: M, character: _ } = j.getLineAndCharacterOfPosition(G);
              return { line: M + 1, column: _ };
            });
            y({ loc: { start: k, end: $ } }, "Decorators are not valid here.");
          }
          function S(I, E) {
        ...
        } }), Tf = K({ "src/language-js/parse/postprocess/index.js"(l, u) {
          "use strict";
          V();
          var { locStart: f, locEnd: d } = yo(), y = yf(), A = gf(), g = Pf(), T = Po(), { throwErrorForInvalidNodes: S } = Af(), F = Ao();
          function I(k, $) {
            if ($.parser === "typescript" && /@|abstract/.test($.originalText) && S(k, $), $.parser !== "typescript" && $.parser !== "flow" && $.parser !== "acorn" && $.parser !== "espree" && $.parser !== "meriyah") {
              let M = /* @__PURE__ */ new Set();
              k = T(k, (_) => {
                _.leadingComments && _.leadingComments.some(A) && M.add(f(_));
              }), k = T(k, (_) => {
            ...
            return k = T(k, (M) => {
              switch (M.type) {
                ...
                case "VariableDeclaration": {
                  let _ = g(M.declarations);
                  _ && _.init && G(M, _);
                  break;
                }
                case "TSParenthesizedType":
                  return y(M.typeAnnotation) || M.typeAnnotation.type === "TSThisType" || (M.typeAnnotation.range = [f(M), d(M)]), M.typeAnnotation;
                case "TSTypeParameter":
                  if (typeof M.name == "string") {
                    let _ = f(M);
                    M.name = { type: "Identifier", name: M.name, range: [_, _ + M.name.length] };
                  }
                  break;
                case "ObjectExpression":
                  if ($.parser === "typescript") {
                    let _ = M.properties.find((h) => h.type === "Property" && h.value.type === "TSEmptyBodyFunctionExpression");
                    _ && F(_.value, "Unexpected token.");
                  }
                  break;
                case "SequenceExpression": {
                  let _ = g(M.expressions);
                  M.range = [f(M), Math.min(d(_), d(M))];
                  break;
                }
                case "TopicReference":
                ...
                case "ExportAllDeclaration": {
                  let { exported: _ } = M;
                  if ($.parser === "meriyah" && _ && _.type === "Identifier") {
                    let h = $.originalText.slice(f(_), d(_));
                    (h.startsWith('"') || h.startsWith("'")) && (M.exported = Object.assign(Object.assign({}, M.exported), {}, { type: "Literal", value: M.exported.name, raw: h }));
                  }
                  break;
                }
                case "PropertyDefinition":
                  if ($.parser === "meriyah" && M.static && !M.computed && !M.key) {
                    let _ = "static", h = f(M);
                    Object.assign(M, { static: false, key: { type: "Identifier", name: _, range: [h, h + _.length] } });
                  }
                  break;
              }
            }), k;
            function G(M, _) {
              $.originalText[d(_)] !== ";" && (M.range = [f(M), d(_)]);
            }
          }
          function E(k) {
            switch (k.type) {
...
- Did you mean \`import { "${r}" as foo }\`?`;
          ...
          function _(t, r) {
            ...
            for (let s of Object.keys(t)) {
              ...
              e[s] = M(Object.assign({ code: A.SyntaxError, reasonCode: s, toMessage: c }, r ? { syntaxPlugin: r } : {}, o));
            }
            return e;
          }
          ...
          var B = true, v = true, We = true, te = true, he = true, bo = true, ur = class {
            constructor(t) {
          ...
          function ie(t, r) {
            return N(t, { beforeExpr: B, binop: r });
          }
          ...
          var Co = { bracketL: N("[", { beforeExpr: B, startsExpr: v }), bracketHashL: N("#[", { beforeExpr: B, startsExpr: v }), bracketBarL: N("[|", { beforeExpr: B, startsExpr: v }), bracketR: N("]"), bracketBarR: N("|]"), braceL: N("{", { beforeExpr: B, startsExpr: v }), braceBarL: N("{|", { beforeExpr: B, startsExpr: v }), braceHashL: N("#{", { beforeExpr: B, startsExpr: v }), braceR: N("}"), braceBarR: N("|}"), parenL: N("(", { beforeExpr: B, startsExpr: v }), parenR: N(")"), comma: N(",", { beforeExpr: B }), semi: N(";", { beforeExpr: B }), colon: N(":", { beforeExpr: B }), doubleColon: N("::", { beforeExpr: B }), dot: N("."), question: N("?", { beforeExpr: B }), questionDot: N("?."), arrow: N("=>", { beforeExpr: B }), template: N("template"), ellipsis: N("...", { beforeExpr: B }), backQuote: N("`", { startsExpr: v }), dollarBraceL: N("${", { beforeExpr: B, startsExpr: v }), templateTail: N("...`", { startsExpr: v }), templateNonTail: N("...${", { beforeExpr: B, startsExpr: v }), at: N("@"), hash: N("#", { startsExpr: v }), interpreterDirective: N("#!..."), eq: N("=", { beforeExpr: B, isAssign: te }), assign: N("_=", { beforeExpr: B, isAssign: te }), slashAssign: N("_=", { beforeExpr: B, isAssign: te }), xorAssign: N("_=", { beforeExpr: B, isAssign: te }), moduloAssign: N("_=", { beforeExpr: B, isAssign: te }), incDec: N("++/--", { prefix: he, postfix: bo, startsExpr: v }), bang: N("!", { beforeExpr: B, prefix: he, startsExpr: v }), tilde: N("~", { beforeExpr: B, prefix: he, startsExpr: v }), doubleCaret: N("^^", { startsExpr: v }), doubleAt: N("@@", { startsExpr: v }), pipeline: ie("|>", 0), nullishCoalescing: ie("??", 1), logicalOR: ie("||", 1), logicalAND: ie("&&", 2), bitwiseOR: ie("|", 3), bitwiseXOR: ie("^", 4), bitwiseAND: ie("&", 5), equality: ie("==/!=/===/!==", 6), lt: ie("</>/<=/>=", 7), gt: ie("</>/<=/>=", 7), relational: ie("</>/<=/>=", 7), bitShift: ie("<</>>/>>>", 8), bitShiftL: ie("<</>>/>>>", 8), bitShiftR: ie("<</>>/>>>", 8), plusMin: N("+/-", { beforeExpr: B, binop: 9, prefix: he, startsExpr: v }), modulo: N("%", { binop: 10, startsExpr: v }), star: N("*", { binop: 10 }), slash: ie("/", 10), exponent: N("**", { beforeExpr: B, binop: 11, rightAssociative: true }), _in: U("in", { beforeExpr: B, binop: 7 }), _instanceof: U("instanceof", { beforeExpr: B, binop: 7 }), _break: U("break"), _case: U("case", { beforeExpr: B }), _catch: U("catch"), _continue: U("continue"), _debugger: U("debugger"), _default: U("default", { beforeExpr: B }), _else: U("else", { beforeExpr: B }), _finally: U("finally"), _function: U("function", { startsExpr: v }), _if: U("if"), _return: U("return", { beforeExpr: B }), _switch: U("switch"), _throw: U("throw", { beforeExpr: B, prefix: he, startsExpr: v }), _try: U("try"), _var: U("var"), _const: U("const"), _with: U("with"), _new: U("new", { beforeExpr: B, startsExpr: v }), _this: U("this", { startsExpr: v }), _super: U("super", { startsExpr: v }), _class: U("class", { startsExpr: v }), _extends: U("extends", { beforeExpr: B }), _export: U("export"), _import: U("import", { startsExpr: v }), _null: U("null", { startsExpr: v }), _true: U("true", { startsExpr: v }), _false: U("false", { startsExpr: v }), _typeof: U("typeof", { beforeExpr: B, prefix: he, startsExpr: v }), _void: U("void", { beforeExpr: B, prefix: he, startsExpr: v }), _delete: U("delete", { beforeExpr: B, prefix: he, startsExpr: v }), _do: U("do", { isLoop: We, beforeExpr: B }), _for: U("for", { isLoop: We }), _while: U("while", { isLoop: We }), _as: q("as", { startsExpr: v }), _assert: q("assert", { startsExpr: v }), _async: q("async", { startsExpr: v }), _await: q("await", { startsExpr: v }), _from: q("from", { startsExpr: v }), _get: q("get", { startsExpr: v }), _let: q("let", { startsExpr: v }), _meta: q("meta", { startsExpr: v }), _of: q("of", { startsExpr: v }), _sent: q("sent", { startsExpr: v }), _set: q("set", { startsExpr: v }), _static: q("static", { startsExpr: v }), _using: q("using", { startsExpr: v }), _yield: q("yield", { startsExpr: v }), _asserts: q("asserts", { startsExpr: v }), _checks: q("checks", { startsExpr: v }), _exports: q("exports", { startsExpr: v }), _global: q("global", { startsExpr: v }), _implements: q("implements", { startsExpr: v }), _intrinsic: q("intrinsic", { startsExpr: v }), _infer: q("infer", { startsExpr: v }), _is: q("is", { startsExpr: v }), _mixins: q("mixins", { startsExpr: v }), _proto: q("proto", { startsExpr: v }), _require: q("require", { startsExpr: v }), _satisfies: q("satisfies", { startsExpr: v }), _keyof: q("keyof", { startsExpr: v }), _readonly: q("readonly", { startsExpr: v }), _unique: q("unique", { startsExpr: v }), _abstract: q("abstract", { startsExpr: v }), _declare: q("declare", { startsExpr: v }), _enum: q("enum", { startsExpr: v }), _module: q("module", { startsExpr: v }), _namespace: q("namespace", { startsExpr: v }), _interface: q("interface", { startsExpr: v }), _type: q("type", { startsExpr: v }), _opaque: q("opaque", { startsExpr: v }), name: N("name", { startsExpr: v }), string: N("string", { startsExpr: v }), num: N("num", { startsExpr: v }), bigint: N("bigint", { startsExpr: v }), decimal: N("decimal", { startsExpr: v }), regexp: N("regexp", { startsExpr: v }), privateName: N("#name", { startsExpr: v }), eof: N("eof"), jsxName: N("jsxName"), jsxText: N("jsxText", { beforeExpr: true }), jsxTagStart: N("jsxTagStart", { startsExpr: true }), jsxTagEnd: N("jsxTagEnd"), placeholder: N("%%", { startsExpr: true }) };
          function z(t) {
            return t >= 93 && t <= 130;
          }
          function So(t) {
          ...
          function de(t) {
            return t < 65 ? t === 36 : t <= 90 ? true : t < 97 ? t === 95 : t <= 122 ? true : t <= 65535 ? t >= 170 && Bo.test(String.fromCharCode(t)) : Jt(t, dr);
          }
          function Be(t) {
            return t < 48 ? t === 36 : t < 58 ? true : t < 65 ? false : t <= 90 ? true : t < 97 ? t === 95 : t <= 122 ? true : t <= 65535 ? t >= 170 && _o.test(String.fromCharCode(t)) : Jt(t, dr) || Jt(t, Ro);
          }
          ...
          var _e = 0, Re = 1, me = 2, Yt = 4, Pr = 8, lt = 16, Ar = 32, Se = 64, ht = 128, je = 256, ut = Re | me | ht | je, ye = 1, we = 2, Tr = 4, Ae = 8, ct = 16, vr = 64, pt = 128, Qt = 256, Zt = 512, es = 1024, ts = 2048, Je = 4096, Er = ye | we | Ae | pt, Ie = ye | 0 | Ae | 0, ft = ye | 0 | Tr | 0, br = ye | 0 | ct | 0, Ko = 0 | we | 0 | pt, Wo = 0 | we | 0 | 0, Cr = ye | we | Ae | Qt, Sr = 0 | es, Te = 0 | vr, Go = ye | 0 | 0 | vr, Jo = Cr | Zt, Xo = 0 | es, wr = 0 | we | 0 | Je, Yo = ts, dt = 4, ss = 2, rs = 1, is = ss | rs, Qo = ss | dt, Zo = rs | dt, el = ss, tl = rs, as = 0, ns = class {
            constructor(t) {
          ...
          function Fr(t, r, e, s, i, a) {
            ...
            for (; ; ) {
              ...
              if (C === 92) {
                ...
                C === 8232 || C === 8233 ? (++e, ++i, s = e) : C === 10 || C === 13 ? t === "template" ? (p += r.slice(x, e) + `
`, ++e, C === 13 && r.charCodeAt(e) === 10 && ++e, ++i, x = s = e) : a.unterminated(n, o, c) : ++e;
            }
...
`);
          ...
          function Lr(t, r, e, s, i, a, n, o, c, p) {
            let m = r, x = i === 16 ? Dr.hex : Dr.decBinOct, P = i === 16 ? yt.hex : i === 10 ? yt.dec : i === 8 ? yt.oct : yt.bin, C = false, O = 0;
            ...
            return r === m || a != null && r - m !== a || C ? { n: null, pos: r } : { n: O, pos: r };
          }
          ...
          var dl = /* @__PURE__ */ new Set([103, 109, 115, 105, 121, 117, 100, 118]), ve = class {
            constructor(t) {
            ...
            skipLineComment(t) {
              ...
              if (this.isLookahead)
                return;
              let i = this.state.pos, a = this.input.slice(r + t, i), n = { type: "CommentLine", value: a, start: r, end: i, loc: new d(e, this.state.curPosition()) };
            ...
            readToken_numberSign() {
              ...
              if (r === 123 || r === 91 && this.hasPlugin("recordAndTuple")) {
                ...
                de(r) ? (++this.state.pos, this.finishToken(136, this.readWord1(r))) : r === 92 ? (++this.state.pos, this.finishToken(136, this.readWord1())) : this.finishOp(27, 1);
            }
            readToken_dot() {
            ...
            readNumber(t) {
              ...
              if (c) {
                ...
                if (this.recordStrictModeErrors(h.StrictOctalLiteral, { at: e }), !this.state.strict) {
                  let C = P.indexOf("_");
                  C > 0 && this.raise(h.ZeroDigitNumericSeparator, { at: y(e, C) });
                }
                o = c && !/[89]/.test(P);
              }
              let p = this.input.charCodeAt(this.state.pos);
              if (p === 46 && !o && (++this.state.pos, this.readInt(10), s = true, p = this.input.charCodeAt(this.state.pos)), (p === 69 || p === 101) && !o && (p = this.input.charCodeAt(++this.state.pos), (p === 43 || p === 45) && ++this.state.pos, this.readInt(10) === null && this.raise(h.InvalidOrMissingExponent, { at: e }), s = true, n = true, p = this.input.charCodeAt(this.state.pos)), p === 110 && ((s || c) && this.raise(h.InvalidBigIntLiteral, { at: e }), ++this.state.pos, i = true), p === 109 && (this.expectPlugin("decimal", this.state.curPosition()), (n || c) && this.raise(h.InvalidDecimal, { at: e }), ++this.state.pos, a = true), de(this.codePointAtPos(this.state.pos)))
                throw this.raise(h.NumberIdentifier, { at: this.state.curPosition() });
            ...
            readWord1(t) {
              ...
              for (t !== void 0 && (this.state.pos += t <= 65535 ? 1 : 2); this.state.pos < this.length; ) {
                ...
                if (Be(i))
                  ...
                  let a = this.state.curPosition(), n = this.state.pos === e ? de : Be;
            ...
            raise(t, r) {
              let { at: e } = r, s = u(r, pl), i = e instanceof f ? e : e.loc.start, a = t({ loc: i, details: s });
              if (!this.options.errorRecovery)
                throw a;
              return this.isLookahead || this.state.errors.push(a), a;
            }
            raiseOverwrite(t, r) {
              let { at: e } = r, s = u(r, fl), i = e instanceof f ? e : e.loc.start, a = i.index, n = this.state.errors;
            ...
            declarePrivateName(t, r, e) {
              ...
              if (r & is) {
                let o = n && i.get(t);
                if (o) {
                  let c = o & dt, p = r & dt, m = o & is, x = r & is;
          ...
          var Fl = /\*?\s*@((?:no)?flow)\b/, Ll = (t) => class extends t {
            ...
            flowParseDeclareVariable(e) {
              return this.next(), e.id = this.flowParseTypeAnnotatableIdentifier(true), this.scope.declareName(e.id.name, ft, e.id.loc.start), this.semicolon(), this.finishNode(e, "DeclareVariable");
            }
            ...
            flowParseInterfaceish(e) {
              let s = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
              if (e.id = this.flowParseRestrictedIdentifier(!s, true), this.scope.declareName(e.id.name, s ? br : Ie, e.id.loc.start), this.match(47) ? e.typeParameters = this.flowParseTypeParameterDeclaration() : e.typeParameters = null, e.extends = [], e.implements = [], e.mixins = [], this.eat(81))
                do
            ...
            flowParseObjectType(e) {
              ...
              let C = this.finishNode(p, "ObjectTypeAnnotation");
              return this.state.inType = c, C;
            }
            ...
            shouldParseDefaultImport(e) {
              return fs(e) ? Ur(this.state.type) : super.shouldParseDefaultImport(e);
            }
            ...
            parseImportSpecifierLocal(e, s, i) {
              s.local = fs(e) ? this.flowParseRestrictedIdentifier(true, true) : this.parseIdentifier(), e.specifiers.push(this.finishImportSpecifier(s, i));
            }
            ...
            parseMaybeAssign(e, s) {
              ...
              if ((i = n) != null && i.error || this.match(47)) {
                ...
                let p, m = this.tryParse((P) => {
                  ...
                  (C = O.extra) != null && C.parenthesized && P();
            ...
            flowEnumBody(e, s) {
              ...
              switch (e.hasUnknownMembers = c, n) {
                ...
                default: {
                  ...
                  let m = o.booleanMembers.length, x = o.numberMembers.length, P = o.stringMembers.length, C = o.defaultedMembers.length;
                  if (!m && !x && !P && !C)
                    return p();
                  if (!m && !x)
...
`) : i = String.fromCharCode(s), ++this.state.curLine, this.state.lineStart = this.state.pos, i;
          ...
          var Hl = (t) => class extends t {
            ...
            tsParseModifiers(e) {
              let { modified: s, allowedModifiers: i, disallowedModifiers: a, stopOnStartOfClassStaticBlock: n, errorTemplate: o = w.InvalidModifierOnTypeMember } = e, c = (m, x, P, C) => {
                x === P && s[C] && this.raise(w.InvalidModifiersOrder, { at: m, orderedModifiers: [P, C] });
              }, p = (m, x, P, C) => {
                (s[P] && x === C || s[C] && x === P) && this.raise(w.IncompatibleModifiers, { at: m, modifiers: [P, C] });
              };
              for (; ; ) {
            ...
            tsParseTypePredicateAsserts() {
              ...
              return this.next(), !z(this.state.type) && !this.match(78) ? false : (e && this.raise(h.InvalidEscapedReservedWord, { at: this.state.lastTokStartLoc, reservedWord: "asserts" }), true);
            }
            ...
            tsParseInterfaceDeclaration(e) {
              ...
              if (this.hasFollowingLineBreak())
                return null;
              this.expectContextual(127), s.declare && (e.declare = true), z(this.state.type) ? (e.id = this.parseIdentifier(), this.checkIdentifier(e.id, Ko)) : (e.id = null, this.raise(w.MissingInterfaceName, { at: this.state.startLoc })), e.typeParameters = this.tsTryParseTypeParameters(this.tsParseInOutModifiers.bind(this)), this.eat(81) && (e.extends = this.tsParseHeritageClause("extends"));
              let i = this.startNode();
            ...
            tsParseEnumDeclaration(e) {
              let s = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
              return s.const && (e.const = true), s.declare && (e.declare = true), this.expectContextual(124), e.id = this.parseIdentifier(), this.checkIdentifier(e.id, e.const ? Jo : Cr), this.expect(5), e.members = this.tsParseDelimitedList("EnumMembers", this.tsParseEnumMember.bind(this)), this.expect(8), this.finishNode(e, "TSEnumDeclaration");
            }
            tsParseModuleBlock() {
              let e = this.startNode();
            ...
            parseMaybeAssign(e, s) {
              ...
              if (!P && (Hr(!this.hasPlugin("jsx")), C = this.tryParse(() => super.parseMaybeAssign(e, s), x), !C.error))
                return C.node;
              if ((a = P) != null && a.node)
              ...
              throw (o = P) != null && o.thrown ? P.error : R.thrown ? R.error : (c = C) != null && c.thrown ? C.error : ((p = P) == null ? void 0 : p.error) || R.error || ((m = C) == null ? void 0 : m.error);
            }
            ...
            parseTypeOnlyImportExportSpecifier(e, s, i) {
              ...
              if (this.isContextual(93)) {
                ...
                if (this.isContextual(93)) {
                  ...
                  pe(this.state.type) ? (p = true, o = C, c = s ? this.parseIdentifier() : this.parseModuleExportName(), m = false) : (c = O, m = false);
                } else
                  pe(this.state.type) ? (m = false, c = s ? this.parseIdentifier() : this.parseModuleExportName()) : (p = true, o = C);
              } else
          ...
          var Jl = (t, r) => Object.hasOwnProperty.call(t, r) && t[r], Yr = (t) => t.type === "ParenthesizedExpression" ? Yr(t.expression) : t, Xl = class extends wl {
            ...
            checkLVal(t, r) {
              ...
              let [x, P] = Array.isArray(m) ? m : [m, p === "ParenthesizedExpression"], C = t.type === "ArrayPattern" || t.type === "ObjectPattern" || t.type === "ParenthesizedExpression" ? t : e;
              for (let O of [].concat(t[x]))
                O && this.checkLVal(O, { in: C, binding: s, checkClashes: i, allowingSloppyLetBinding: n, strictModeChanged: a, hasParenthesizedAncestor: P });
            }
            checkIdentifier(t, r) {
            ...
            parseParenAndDistinguishExpression(t) {
              ...
              for (; !this.match(11); ) {
                ...
                if (this.match(21)) {
                  ...
                  if (p = this.state.startLoc, n.push(this.parseParenItem(this.parseRestBinding(), C)), !this.checkCommaAfterRest(41))
                    break;
                } else
...
`), cooked: i === null ? null : i.slice(1, c) }, n.tail = o, this.next();
            ...
            checkParams(t, r, e) {
              ...
              for (let n of t.params)
                this.checkLVal(n, { in: a, binding: ft, checkClashes: i, strictModeChanged: s });
            }
          ...
          }, ds = { kind: "loop" }, Ql = { kind: "switch" }, Zl = 0, ms = 1, Qr = 2, Zr = 4, eh = /[\uD800-\uDFFF]/u, ys = /in(?:stanceof)?/y;
          function th(t, r) {
              ...
              if (typeof i == "number") {
                {
                  if (i === 136) {
                    ...
                    t.splice(e, 1, new ve({ type: fe(27), value: "#", start: n, end: p, startLoc: a.start, endLoc: m }), new ve({ type: fe(130), value: o, start: p, end: c, startLoc: m, endLoc: a.end })), e++;
                    continue;
                  }
                  if (ot(i)) {
                    let { loc: a, start: n, value: o, end: c } = s, p = n + 1, m = y(a.start, 1), x;
                    r.charCodeAt(n) === 96 ? x = new ve({ type: fe(22), value: "`", start: n, end: p, startLoc: a.start, endLoc: m }) : x = new ve({ type: fe(8), value: "}", start: n, end: p, startLoc: a.start, endLoc: m });
                    let P, C, O, R;
                    i === 24 ? (C = c - 1, O = y(a.end, -1), P = o === null ? null : o.slice(1, -1), R = new ve({ type: fe(22), value: "`", start: C, end: c, startLoc: O, endLoc: a.end })) : (C = c - 2, O = y(a.end, -2), P = o === null ? null : o.slice(1, -2), R = new ve({ type: fe(23), value: "${", start: C, end: c, startLoc: O, endLoc: a.end })), t.splice(e, 1, x, new ve({ type: fe(20), value: P, start: p, end: C, startLoc: m, endLoc: O }), R), e += 2;
                    continue;
                  }
                }
                s.type = fe(i);
          ...
          var sh = class extends Yl {
            ...
            parseStatementContent(t, r, e) {
              ...
              return z(s) && n.type === "Identifier" && this.eat(14) ? this.parseLabeledStatement(i, a, n, t) : this.parseExpressionStatement(i, n, e);
            }
            ...
            parseDoStatement(t) {
              return this.next(), this.state.labels.push(ds), t.body = this.withSmartMixTopicForbiddingContext(() => this.parseStatement("do")), this.state.labels.pop(), this.expect(92), t.test = this.parseHeaderExpression(), this.eat(13), this.finishNode(t, "DoWhileStatement");
            }
            parseForStatement(t) {
              this.next(), this.state.labels.push(ds);
              let r = null;
            ...
            parseWhileStatement(t) {
              return this.next(), t.test = this.parseHeaderExpression(), this.state.labels.push(ds), t.body = this.withSmartMixTopicForbiddingContext(() => this.parseStatement("while")), this.state.labels.pop(), this.finishNode(t, "WhileStatement");
            }
            ...
            parseVarId(t, r) {
              ...
              r === "using" && e.type !== "Identifier" && this.raise(h.UsingDeclarationHasBindingPattern, { at: e }), this.checkLVal(e, { in: { type: "VariableDeclarator" }, binding: r === "var" ? ft : Ie }), t.id = e;
            }
            parseFunction(t) {
            ...
            registerFunctionStatementId(t) {
              !t.id || this.scope.declareName(t.id.name, this.state.strict || t.generator || t.async ? this.scope.treatFunctionsAsVar ? ft : Ie : br, t.id.loc.start);
            }
            parseClass(t, r, e) {
              this.next();
            ...
            parseClassMemberWithIsStatic(t, r, e, s) {
              ...
              let x = z(this.state.type) && !this.state.containsEsc, P = this.match(136), C = this.parseClassElementName(r), O = this.state.startLoc;
              if (this.parsePostMemberNameModifiers(m), this.isClassMethod()) {
                ...
                R && (i.kind = "constructor", e.hadConstructor && !this.hasPlugin("typescript") && this.raise(h.DuplicateConstructor, { at: C }), R && this.hasPlugin("typescript") && r.override && this.raise(h.OverrideOnConstructor, { at: C }), e.hadConstructor = true, Q = e.hadSuperClass), this.pushClassMethod(t, i, false, false, R, Q);
              } else if (this.isClassProperty())
                P ? this.pushClassPrivateProperty(t, o) : this.pushClassProperty(t, n);
              else if (x && C.name === "async" && !this.isLineTerminator()) {
              ...
              } else if (x && (C.name === "get" || C.name === "set") && !(this.match(55) && this.isLineTerminator())) {
              ...
              } else if (x && C.name === "accessor" && !this.isLineTerminator()) {
            ...
            parseMaybeImportReflection(t) {
              ...
              if (this.isContextual(125)) {
                ...
                z(e.type) ? (e.type !== 97 || this.input.charCodeAt(this.nextTokenStartSince(e.end)) === 102) && (r = true) : r = true;
              }
        ...
        } }), vf = K({ "src/language-js/parse/json.js"(l, u) {
          "use strict";
          V();
          var f = lr(), d = hr(), y = xo(), A = go();
          function g() {
            let E = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, { allowComments: L = true } = E;
            return function(k) {
              let { parseExpression: $ } = To(), G;
              try {
                G = $(k, { tokens: true, ranges: true });
              } catch (M) {
                throw A(M);
              }
              if (!L && f(G.comments))
          ...
          function T(E, L) {
            let [j, k] = [E.loc.start, E.loc.end].map(($) => {
              let { line: G, column: M } = $;
              return { line: G, column: M + 1 };
            });
        ...
        function Ff(l, u) {
          ...
          let d = Cf(l, 0);
          return d !== false && (l = l.slice(0, d)), Df.test(l);
        }
        function Lf(l, u, f) {
          let y = To()[l](u, f), A = y.errors.find((g) => !jf.has(g.reasonCode));
          if (A)
            throw A;
          return y;
        }
        function Ke(l) {
          ...
          return function(y, A) {
            ...
            if ((g.parser === "babel" || g.parser === "__babel_estree") && Ff(y, g))
              return g.parser = "babel-flow", vo(y, A, g);
            let T = f;
            g.__babelSourceType === "script" && (T = T.map((E) => Object.assign(Object.assign({}, E), {}, { sourceType: "script" }))), /#[[{]/.test(y) && (T = T.map((E) => ue([kf], E)));
            let S = /%[A-Z]/.test(y);
            y.includes("|>") ? T = (S ? [...Jn, Gn] : Jn).flatMap((L) => T.map((j) => ue([L], j))) : S && (T = T.map((E) => ue([Gn], E)));
            let { result: F, error: I } = Ef(...T.map((E) => () => Lf(l, y, E)));
            if (!F)
              throw Sf(I);
            return g.originalText = y, wf(F, g);
          };
        }
        var Of = Ke("parse", ue(["jsx", "flow"])), vo = Ke("parse", ue(["jsx", ["flow", { all: true, enums: true }]])), Mf = Ke("parse", ue(["jsx", "typescript"]), ue(["typescript"])), Bf = Ke("parse", ue(["jsx", "flow", "estree"])), _f = Ke("parseExpression", ue(["jsx"])), Rf = Ke("parseExpression", ue(["typescript"])), jf = /* @__PURE__ */ new Set(["StrictNumericEscape", "StrictWith", "StrictOctalLiteral", "StrictDelete", "StrictEvalArguments", "StrictEvalArgumentsBinding", "StrictFunction", "EmptyTypeArguments", "EmptyTypeParameters", "ConstructorHasTypeParameters", "UnsupportedParameterPropertyKind", "UnexpectedParameterModifier", "MixedLabeledAndUnlabeledElements", "InvalidTupleMemberLabel", "NonClassMethodPropertyHasAbstractModifer", "ReadonlyForMethodSignature", "ClassMethodHasDeclare", "ClassMethodHasReadonly", "InvalidModifierOnTypeMember", "DuplicateAccessibilityModifier", "IndexSignatureHasDeclare", "DecoratorExportClass", "ParamDupe", "InvalidDecimal", "RestTrailingComma", "UnsupportedParameterDecorator", "UnterminatedJsxContent", "UnexpectedReservedWord", "ModuleAttributesWithDuplicateKeys", "LineTerminatorBeforeArrow", "InvalidEscapeSequenceTemplate", "NonAbstractClassHasAbstractMethod", "UnsupportedPropertyDecorator", "OptionalTypeBeforeRequired", "PatternIsOptional", "OptionalBindingPattern", "DeclareClassFieldHasInitializer", "TypeImportCannotSpecifyDefaultAndNamed", "DeclareFunctionHasImplementation", "ConstructorClassField", "VarRedeclaration", "InvalidPrivateFieldResolution", "DuplicateExport"]), Xn = Ve(Of), Yn = Ve(Mf), Qn = Ve(_f), qf = Ve(Rf);
        Eo.exports = { parsers: Object.assign(Object.assign({ babel: Xn, "babel-flow": Ve(vo), "babel-ts": Yn }, If), {}, { __js_expression: Qn, __vue_expression: Qn, __vue_ts_expression: qf, __vue_event_binding: Xn, __vue_ts_event_binding: Yn, __babel_estree: Ve(Bf) }) };
      });
      return Uf();
    });
  }
